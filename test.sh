...
e2e() {
  ...
  ./node_modules/.bin/cypress run --config baseUrl=http://localhost --env REACT_APP_API_GATEWAY_URL=https://eq9oax74xe.execute-api.us-west-1.amazonaws.com/v1/execute,LOAD_BALANCER_STAGE_DNS_NAME=http://localhost
  inspect $? e2e
